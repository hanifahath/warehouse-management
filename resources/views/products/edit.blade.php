    ...
    <div class="bg-white shadow-lg rounded-xl p-6 border border-gray-200">
        <form action="{{ route('products.update', $product) }}" method="POST" enctype="multipart/form-data" class="space-y-8">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                    ...
                    <select id="unit" name="unit"
                        ...
                        <option value="box" {{ old('unit', $product->unit) == 'box' ? 'selected' : '' }}>Box (Kotak)</option>
                        ...
                        <option value="pack" {{ old('unit', $product->unit) == 'pack' ? 'selected' : '' }}>Pack (Pak)</option>
                        <option value="dus" {{ old('unit', $product->unit) == 'dus' ? 'selected' : '' }}>Dus</option>
                        <option value="lainnya" {{ old('unit', $product->unit) == 'lainnya' ? 'selected' : '' }}>Lainnya</option>
                    </select>
                </div>
            </div>
            ...
            <div class="border-b border-gray-200 pb-4 pt-6">
                ...
                <p class="text-sm text-gray-600 mt-1">Kelola stok dan penempatan di gudang</p>
            </div>
